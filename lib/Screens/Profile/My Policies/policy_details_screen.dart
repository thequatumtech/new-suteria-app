                      ...
                      Padding(
                        ...
                        child: Column(
                          children: [
                            ...
                            const SizedBox(height: 10),
                            _buildDetailRow('Plan Limit', widget.policyData.policyPlanLimit != null ? '${widget.policyData.policyPlanLimit}' : '-'),
                            const SizedBox(height: 10),
                            _buildDetailRow('Gross Premium', widget.policyData.grossPremium != null ? '${widget.policyData.grossPremium}' : '-'),
                            const SizedBox(height: 10),
