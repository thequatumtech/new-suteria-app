                            ...
                            Navigator.push(
                                ...
                                MaterialPageRoute(
                                  builder: (context) => InsuranceDraftPdfScreen(
                                    ...
                                    data: {
                                      'rent_contract': homeInsuranceController.rentContractDoc.join(','),
                                      'property_document': homeInsuranceController.propertyDoc.join(','),
                                      'content_document': homeInsuranceController.contentsDoc.join(','),
                                      ...
                                      'protection_system': homeInsuranceController.selectProtectionSystemList.map((e) => e.value).join(','),
                                      'home_age': homeInsuranceController.selectedAgeId != null ? homeInsuranceController.selectedAgeId.toString() : (homeInsuranceController.selectedAgeItem ?? ''),
