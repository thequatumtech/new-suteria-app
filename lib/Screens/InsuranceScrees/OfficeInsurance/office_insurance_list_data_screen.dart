                                ...
                                MaterialPageRoute(
                                  builder: (context) => InsuranceDraftPdfScreen(
                                    ...
                                    data: {
                                      ...
                                      'no_of_floor': officeInsuranceController.selectNoOfFloor?.trim() ?? '',
                                      'no_of_room': officeInsuranceController.selectedroomsItem?.trim() ?? '',
                                      'size_of_apartment': officeInsuranceController.officeSizeController.value.text,
                                      'age_of_apartment': officeInsuranceController.selectedAgeId != null ? officeInsuranceController.selectedAgeId.toString() : (officeInsuranceController.selectAgeOfBuilding?.trim() ?? ''),
                                      ...
                                      'protection_system': officeInsuranceController.selectProtectionSystemList.map((e) => e.value).join(','),
                                      ...
                                      'rent_contract_documents': officeInsuranceController.selectedRentDocument.join(','),
                                      'property_photo_documents': officeInsuranceController.selectedPropertyDocument.join(','),
                                      'contents_documents': officeInsuranceController.selectedContentsDocument.join(','),
                                      'policy_issuer_documents': officeInsuranceController.selectedAuthorizationDocument.join(','),
                                      'company_owner_documents': officeInsuranceController.selectedRegistrationDocument.join(','),
                                      'career_municipality_license_documents': officeInsuranceController.selectedLicenseDocument.join(','),
                                      'owner_id_documents': officeInsuranceController.selectedOwnersIdDocument.join(','),
                                      'practice_documents': officeInsuranceController.selectedPracticeCertificateDocument.join(','),
                            ...
                            child: Container(
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  AppText(text: "${getTranslated(context, theQuoteIs)}: ${officeInsuranceController.officeInsurancePlanModel.value.data?[index].grossPremium ?? ''} ${getTranslated(context, 'JOD')}", txtColor: deepBlue, fontWeight: FontWeight.bold, size: 15),
