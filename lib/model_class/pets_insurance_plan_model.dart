class GetPetsInsurancePlanModel {
  bool? status;
  int? statusCode;
  String? message;
  List<Data>? data;

  GetPetsInsurancePlanModel(
      {this.status, this.statusCode, this.message, this.data});

  GetPetsInsurancePlanModel.fromJson(Map<String, dynamic> json) {
    status = json['status'];
...
class PolicyCovers {
  ...
  Map<String, dynamic> toJson() {
    final Map<String, dynamic> data = new Map<String, dynamic>();
    data['id'] = this.id;
    data['pet_plan_id'] = this.petPlanId;
