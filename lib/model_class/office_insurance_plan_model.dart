class OfficeInsurancePlanModel {
  bool? status;
  int? statusCode;
  String? message;
  List<Data>? data;

  OfficeInsurancePlanModel({this.status, this.statusCode, this.message, this.data});

  OfficeInsurancePlanModel.fromJson(Map<String, dynamic> json) {
    status = json['status'];
...
class Data {
  ...
  Data.fromJson(Map<String, dynamic> json) {
    id = json['id']!= null ? double.parse(json['id'].toString()) : 0;
    ...
    limit = json['limit']!= null ? double.parse(json['limit'].toString()) : 0;
    ...
    insuranceCompany = json['insurance_company'] != null ? new InsuranceCompany.fromJson(json['insurance_company']) : null;
  }
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this.policyCovers != null) {
      data['policy_covers'] = this.policyCovers!.map((v) => v.toJson()).toList();
    }
...
class PolicyCovers {
  ...
  PolicyCovers({this.id, this.officePlanId, this.coverName, this.coverLimit, this.coverLimitType, this.coverDeductible, this.coverDeductibleType, this.coverRate, this.coverRateType, this.coverPremium, this.createdAt, this.updatedAt, this.deletedAt});

  PolicyCovers.fromJson(Map<String, dynamic> json) {
    id = json['id']!= null ? double.parse(json['id'].toString()) : 0;
    officePlanId = json['office_plan_id']!= null ? double.parse(json['office_plan_id'].toString()) : 0;
    coverName = json['cover_name'];
    coverLimit = json['cover_limit']!= null ? double.parse(json['cover_limit'].toString()) : 0;
  ...
  Map<String, dynamic> toJson() {
    final Map<String, dynamic> data = new Map<String, dynamic>();
    data['id'] = this.id;
    data['office_plan_id'] = this.officePlanId;
