...
class Data {
  ...
  Data.fromJson(Map<String, dynamic> json) {
    ...
    insurancePeriodId = json['insurance_period_id'];
  ...
  Map<String, dynamic> toJson() {
    ...
    data['insurance_period_id'] = this.insurancePeriodId;
...
class PolicyCovers {
  ...
  PolicyCovers.fromJson(Map<String, dynamic> json) {
    id = json['id'];
    personalAccidentPlanId = json['personal_accident_plan_id'];
  ...
  Map<String, dynamic> toJson() {
    final Map<String, dynamic> data = new Map<String, dynamic>();
    data['id'] = this.id;
    data['personal_accident_plan_id'] = this.personalAccidentPlanId;
